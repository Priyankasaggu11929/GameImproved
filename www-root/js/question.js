...
QuizGame.Question.prototype = {
    ...
    addChoiceGroup:function(title,isRightAnswer){
        ...
        var text = this.game.add.text(0,0,title, {font: "12pt Audiowide", fill: "#000000", wordWrap: false,  align: "left", backgroundColor: '#f4bf42' });
    ...
    showScore:function(score,total){
        var style = { 
            font: "20pt Audiowide", fill: "#7C00F8", wordWrap: false,  align: "right", backgroundColor: '#f4bf42'
        };
